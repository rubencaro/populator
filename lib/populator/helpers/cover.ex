defmodule Populator.Helpers.Cover do
  @moduledoc """
  ...
  def project do
    [app: :Populator,
     ...,
     test_coverage: [tool: Populator.Helpers.Cover, ignored: [Populator.Helpers]],
     aliases: aliases]
  end
  ```
  ...
  defp get_results(opts) do
    ...
    %Populator.Helpers.Cover{rate: rate, not_covered: nc, errors: fail, opts: opts}
  end
  ...
  defp format_results(%Populator.Helpers.Cover{} = data) do
